	...
	public void popola() {
		try {
			Prodotto prodotto = new Prodotto("Mandarini", "Ortofrutta snc", "30/12/2017", Categoria.ALIMENTI, 3.0,
					Unita.CHILO, 1.50, "https://www.casaegiardino.it/images/2013/03/foto-mandarini.jpg", "https://s18.postimg.org/gh9c9if95/banner-mandarini.jpg");
			Prodotto prodotto1 = new Prodotto("Riso Scotti Sapori e Emozioni, Basmati Profumato", "Riso Scotti",
					...
					"https://images-na.ssl-images-amazon.com/images/I/91D3vbEIpeL._SL1500_.jpg", "https://s18.postimg.org/nkh7p5uzd/banner-riso-scotti.jpg");
			Prodotto prodotto2 = new Prodotto("Essiccatore Scarpe Deodorante Deumidificatore", "Yosoo", "10/10/3000",
					...
					"https://images-na.ssl-images-amazon.com/images/I/61Un2EBawOL._SL1001_.jpg", "https://s18.postimg.org/79h3spsqh/banner_essicatore-01.jpg");
			Prodotto prodotto3 = new Prodotto("Pampers Sole e Luna Salviettine", "Pampers", "10/10/3000",
					...
					"https://images-na.ssl-images-amazon.com/images/I/71ZMTLD1jdL._SL1000_.jpg", "https://s18.postimg.org/n7ptiyhuh/banner-pampers.jpg");
			Prodotto prodotto4 = new Prodotto("Domopak Sacchi Pattumiera Media", "Domo Pak", "10/10/3000",
					...
					"https://images-na.ssl-images-amazon.com/images/I/71hmKalM-gL._SL1500_.jpg", "https://s18.postimg.org/7yzw53o55/banner-_Domopak.jpg");
			Prodotto prodotto5 = new Prodotto("Foxy, Carta Igienica mega - Pacco da 4 Rotoli", "Foxy", "10/10/3000",
					...
					"https://images-na.ssl-images-amazon.com/images/I/81t78AN6ptL._SL1500_.jpg", "https://s18.postimg.org/cxnejo9yh/banner--foxy.jpg");
			Prodotto prodotto6 = new Prodotto("Whiskas Pranzetti di Casa Pesce", "Whiskas", "12/10/2020",
					Categoria.ANIMALI, 321, Unita.PEZZO, 1.42,
					"https://images-na.ssl-images-amazon.com/images/I/81TK-ktuzRL._SL1500_.jpg", "https://s18.postimg.org/vr97g6815/banner-whiskas.jpg");
			Prodotto prodotto7 = new Prodotto("Grey Acchiappacolore", "Grey", "00/00/0000", Categoria.PROD_CASA, 231,
					Unita.PEZZO, 2.94, "https://images-na.ssl-images-amazon.com/images/I/91yUjaXeJKL._SL1500_.jpg", "https://s18.postimg.org/fez5qz45l/banner-l_acchiappacolori.jpg");
			Prodotto prodotto8 = new Prodotto("Durex Settebello Classico Preservativi - 27", "Durex", "20/10/2019",
					...
					"https://images-na.ssl-images-amazon.com/images/I/618M-aRQeaL._SL1000_.jpg", "https://s18.postimg.org/ws9g5rml5/banner-_DUREX.jpg");
			Prodotto prodotto9 = new Prodotto("Broccoli siciliani", "Broccol srl", "20/12/2017", Categoria.ALIMENTI, 31,
					Unita.CHILO, 6.95, "http://www.mondodelgusto.it/gallery/15994.jpg", "https://s18.postimg.org/7yzw53gfd/banner-broccoli.jpg");
			Prodotto prodotto10 = new Prodotto("Filetti di Sgombro in Olio di Oliva - 230 gr", "Angelo Parodi",
					...
					"https://images-na.ssl-images-amazon.com/images/I/A18E5zUREVL._SL1500_.jpg", "https://s18.postimg.org/w2qntf1h5/banner-_FILETTO.jpg");
			Prodotto prodotto12 = new Prodotto("Sole Pump Oxy Concentrato", "Sole", "20/12/2019", Categoria.PROD_CASA,
					129, Unita.PEZZO, 1.99,
					"https://images-na.ssl-images-amazon.com/images/I/811z5q-DKJL._SL1500_.jpg", "https://s18.postimg.org/dboqis9c9/banner_sole-01.jpg");
			Prodotto prodotto13 = new Prodotto("Borotalco Polvere per la Pelle Rinfrescante e Assorbente",
					...
					"https://images-na.ssl-images-amazon.com/images/I/81QIZmwegUL._SL1500_.jpg", "https://s18.postimg.org/l35ghrt1l/banner-borotalco.jpg");
			Prodotto prodotto14 = new Prodotto("Casaldomo Rocca dei Forti Fragolino", "Casaldomo", "20/01/3000",
					...
					"https://images-na.ssl-images-amazon.com/images/I/71KbgPxX3eL._SL1500_.jpg", "https://s18.postimg.org/8oiohim4p/banner-fragolino-01-01.jpg");
			Prodotto prodotto15 = new Prodotto("Passata di Pomodoro 100% Italiano", "Mutti", "12/03/2019",
					Categoria.ALIMENTI, 39, Unita.PEZZO, 0.95,
					"https://images-na.ssl-images-amazon.com/images/I/81d7wix3DsL._SL1500_.jpg", "https://s18.postimg.org/676xaaryh/banner-pomodoro-01.jpg");
			Prodotto prodotto16 = new Prodotto("Pan di Stelle, Biscotti Frollini", "Barilla", "23/03/2018",
					...
					"https://images-na.ssl-images-amazon.com/images/I/91TdlNcj-SL._SL1500_.jpg", "https://s18.postimg.org/gh9c9j2eh/banner-pan-di-stelle.jpg");
			Prodotto prodotto17 = new Prodotto("Viakal Spray Anticalcare e Discrostante", "Viakal", "02/03/2045",
					...
					"https://images-na.ssl-images-amazon.com/images/I/71NUsRSmrjL._SL1500_.jpg", "https://s18.postimg.org/eqqb7hna1/banner-viakal.jpg");
			Prodotto prodotto18 = new Prodotto("Finish Deodorante per Lavastoviglie Profumo di Limone", "Finish",
					...
					"https://images-na.ssl-images-amazon.com/images/I/81d1ql8VI3L._SL1500_.jpg", "https://s18.postimg.org/42mk94qax/banner-finish.jpg");
			Prodotto prodotto19 = new Prodotto("Schizzetto 4 CC 65", "Sunstar", "02/03/2045", Categoria.PROD_CASA, 21,
					Unita.PEZZO, 6.49, "https://images-na.ssl-images-amazon.com/images/I/61AS2U09nzL._SL1000_.jpg", "https://s18.postimg.org/5ho4xv6tl/banner_schizzo-01.jpg");
			Prodotto prodotto20 = new Prodotto("Gourmet Gold Tortini Pesce - 24 Pezzi da 4x85 gr", "Gourmet",
					...
					"https://images-na.ssl-images-amazon.com/images/I/81or%2B9FftbL._SL1500_.jpg", "https://s18.postimg.org/42mk95svt/banner-gourmet.jpg");
